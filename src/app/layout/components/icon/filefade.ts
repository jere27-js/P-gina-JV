...
@Component({
  ...
  template: `
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" fill="none" [class]="className">
        ...
        />
        <path d="M32.3564 13.333L23.3327 4.30932V11.6663C23.3327 12.5868 24.0789 13.333 24.9993 13.333H32.3564Z" fill="url(#paint1_linear_4307_7477)" />
        <defs>
            <linearGradient id="paint0_linear_4307_7477" x1="19.9994" y1="3.74988" x2="19.9994" y2="36.6663" gradientUnits="userSpaceOnUse">
                <stop stop-color="white" />
                <stop offset="1" stop-color="white" stop-opacity="0" />
            </linearGradient>
            <linearGradient id="paint1_linear_4307_7477" x1="19.9994" y1="3.74988" x2="19.9994" y2="36.6663" gradientUnits="userSpaceOnUse">
                <stop stop-color="white" />
                <stop offset="1" stop-color="white" stop-opacity="0" />
            </linearGradient>
        </defs>
